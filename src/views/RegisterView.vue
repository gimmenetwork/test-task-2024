...
<template>
  ...
  <div class="flex flex-col items-center justify-center mx-auto md:h-screen lg:py-0">
      <div class="w-full bg-white rounded-lg shadow md:mt-0 sm:max-w-md bg-gradient-to-r from-bermuda-gray-200 to-bermuda-gray-300">
          <div class="space-y-4 md:space-y-6 p-12">
              ...
              <form class="space-y-4 md:space-y-6" @submit="onSubmit">
                  <div>
                      ...
                      <input type="firstname" v-bind="firstnameAttrs" name="firstname" aria-errormessage="err-firstname" v-model="firstname" placeholder="Enter your first name" class="bg-gray-50 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-3">
                  </div>
                  <div>
                      <p id="err-lastname">{{ errors.lastname }}</p>
                      <label for="lastname" class="block mb-2 text-sm font-medium text-gray-900 ">Lastname</label>
                      <input type="lastname" v-bind="lastnameAttrs" name="lastname" aria-errormessage="err-lastname" v-model="lastname" placeholder="Enter your last name" class="bg-gray-50 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-3">
                  </div>
                  <div>
                  ...
                  <p class="text-sm font-light text-gray-500">
                      Already have an account? <RouterLink class="font-medium underline" to="/">Login Here</RouterLink>
                  </p>
              </form>
          </div>
      </div>
