<template>
  <form @submit.prevent="handleLogin" class="bg-amber-100 w-full shadow-md rounded flex-1 px-8 pt-6 pb-8 mb-4">
    ...
    <div>
      ...
      <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="password" v-model="formData.password" type="password" required>
    </div>
